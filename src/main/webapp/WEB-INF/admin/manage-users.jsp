    ...
    <aside class="sidebar">
        <div class="sidebar-section">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="${pageContext.request.contextPath}/admin/users" class="active"><span class="nav-icon"><i class="fa-solid fa-users" aria-hidden="true"></i></span> Users</a>
...
<div class="modal-overlay" id="addUserModal">
    <div class="modal">
        <div class="modal-header">
            <h3><i class="fa-solid fa-plus" aria-hidden="true"></i> Add New User</h3>
            <button class="modal-close" onclick="ModalManager.close('addUserModal')"><i class="fa-solid fa-xmark" aria-hidden="true"></i></button>
        </div>
        <form action="${pageContext.request.contextPath}/admin/users" method="POST">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary"><i class="fa-solid fa-plus" aria-hidden="true"></i> Add User</button>
            </div>
        </form>
    </div>
</div>
